package com.example.dailyupdates.utils;
...
public class Constants {
    ...
    public static final String NEWS_REQUEST_URL = " https://www.theguardian.com/editions?q=india&api-key=d9331caa-44a5-40c5-8ecb-d66f01ee81a1";
    ...
    /** API Key */
    public static final String API_KEY = "d9331caa-44a5-40c5-8ecb-d66f01ee81a1"; // Use your API Key when API rate limit exceeded
